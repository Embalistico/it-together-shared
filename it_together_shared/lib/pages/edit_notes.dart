...
//Page for editing notes. The user navigates here by trying to add a new note with the floating button on the home screen.
...
class _NotesEdit extends State<NotesEdit> {
  ...
  //Controllers for editing the note's content and title
  ...
  //Method called by color palette button in top corner
  ...
  // Method called when exiting the edit note window. Returns to home and saves the note.
  ...
  // Called by handleBackButton to insert note into database
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: 'Back',
          //Navigate back to home, and save created note
...
//Dialog box called my the handleColor() method to open a dialog box to pick colors
